...
import {incomingCallRequest, socketConnection} from '../services/socketService';

const Index = ({navigation, session, chatToken}) => {
  {
    /* Edited by Yaseen */
  }
    ...
    <View style={styles.maininner}>
      <View style={styles.r1}>
        <View style={styles.c1}>
          ...
          <Text style={{fontSize: 14 * fontRef, color: 'gray'}}>
      ...
      <Text style={{color: 'grey'}}>
        It was a successfully completed appointment
      </Text>
      ...
      <View style={styles.row}>
        ...
        <View style={styles.c1}>
          ...
          <Text style={{color: 'white'}}>
            Duration:{' '}
            {Math.round(
              (item.appointmentDetails.endTime -
